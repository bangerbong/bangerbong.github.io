document.addEventListener('DOMContentLoaded', () => {
    ...
    draggableDesktopElements.forEach(element => {
        ...
        let hasMoved = false; // To distinguish drag from click for dblclick
        ...
        dragHandle.addEventListener('mousedown', (e) => {
            ...
            highestDesktopZ++; // Increment z-index for desktop elements
        ...
        document.addEventListener('mousemove', (e) => {
            ...
            hasMoved = true; // Flag that mouse has moved
        ...
        if (element.classList.contains('icon')) {
            element.addEventListener('dblclick', () => {
                // Only open window if it wasn't a drag (hasMoved will be true if mousemove fired)
                if (!hasMoved && element.dataset.window) {
                    openWindowById(element.dataset.window);
                }
                // Reset hasMoved for next interaction sequence, though mousedown will also do this.
                // This timeout helps ensure hasMoved reflects the state of the *just completed* mouse interaction
    ...
    function triggerGameOver(isWin) {
        ...
        m_cells.forEach(cell => {
            ...
            if (!cell.mine && cell.flagged && !isWin) cell.el.textContent = '❌';
        });
